    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      _snowflakes = List.generate(100, (_) {
        return Snowflake(
          ...
          speed:
              _random.nextDouble() * 1 + 0.5, // **Reduced Speed: 0.5 to 1.5**
          drift: _random.nextDouble() * 0.5 -
              0.25, // **Reduced Drift: -0.25 to +0.25**
        );
      });
      _controller.repeat();
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        ...
        // 2. Render the main content above the background
        widget.child,
        // 3. Paint the snowflakes on top of the child
        IgnorePointer(
          child: CustomPaint(
